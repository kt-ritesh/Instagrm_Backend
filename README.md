...
I have created instagram bcakend  project using using SpringBoot and MySQl. In this project a new user can create a instagram account , add a new post, user can commnet on the post and like the post, delete there post and user can do many more things in this backend instagram project....
